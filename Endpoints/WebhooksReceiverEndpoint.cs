...
//    {
//        // Get the DigitalSignature header
//        if (!context.Request.Headers.TryGetValue("DigitalSignature", out var digitalSignatureHeader))
//        {
//            return Results.BadRequest("Missing DigitalSignature header");
//        }
        
//        var digitalSignature = digitalSignatureHeader.FirstOrDefault();
//        if (string.IsNullOrEmpty(digitalSignature))
//        {
//            return Results.BadRequest("Invalid DigitalSignature header");
//        }
